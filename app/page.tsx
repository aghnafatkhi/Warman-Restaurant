  ...
  return (
    <main className="min-h-screen bg-bone">
      ...
      <div 
        ...
        className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-ink/95 backdrop-blur-md border-t border-bone/10 flex p-3 pb-[calc(0.75rem+env(safe-area-inset-bottom,0px))] gap-2.5 shadow-[0_-4px_20px_rgba(0,0,0,0.3)]"
      >
        <a 
      ...
      <div className="h-[calc(4rem+env(safe-area-inset-bottom,0px))] md:hidden bg-ink" aria-hidden="true" /> {/* Spacer for mobile sticky bar */}
    </main>
  );
}
